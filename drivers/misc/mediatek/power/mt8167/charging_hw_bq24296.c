...
static unsigned int charging_hw_init(void *data)
{
	...
	bq24296_set_iterm(0x0); /*Termination current 0:128mA,1:256mA*/
	...
	bq24296_set_vreg(0x2e); /*VREG 2d:4224000,2e:4240000V*/
#endif
...
static unsigned int charging_set_cv_voltage(void *data)
{
	...
	#else
		/*use nearest value*/
//		cv_value = 4208000;//DVT2:4.17V

//		cv_value = 4240000;//PVT:4.227V     @0.013V
		cv_value = 4224000; //PVT:4.211V    @0.013V
	#endif
	}
