...
#include "sp2509mipiraw_Sensor_msd.h"

/****************************Modify following Strings for debug****************************/
#define PFX "SP2509_camera_sensor_msd"
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = SP2509_MSD_SENSOR_ID,
...
static kal_uint32 return_sensor_id(void)
{
	...
	return (((read_cmos_sensor(0x02) << 8) | read_cmos_sensor(0x03))+1);//Neostra huangjianlong 20170717.
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	//Neostra huangjianlong 20170717 for msd module.
	if(!gIsMsdModule) {
		printk("[hjl] get_imgsensor_id: sp2509 is not msd module, return directly.\n");
...
UINT32 SP2509_MIPI_RAW_SensorInit_msd(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
